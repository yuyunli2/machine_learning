...
class Neural_Network():
    ...
    def forward(self, X):
        ...
        self.b = self.sigmoid(z)
        h = np.dot(self.b, self.W) + self.f
        c = self.sigmoid(h)
        return c
    ...
    def error_at_layer1(self, delta_k, W, b):
        ...
        '''
        delta_j = np.matmul(delta_k, W.T) * self.sigmoidPrime(b)
        return delta_j
    ...
    def derivative_of_w(self, b, delta_k):
        ...
        '''
        d_w = (1/batchSize)*np.matmul(b.T, delta_k)
        return d_w
    ...
    def derivative_of_u(self, X, delta_j):
        ...
        '''
        d_u = (1/batchSize)*np.matmul(X.T, delta_j)
        return d_u
